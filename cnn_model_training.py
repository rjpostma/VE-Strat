# -*- coding: utf-8 -*-
"""
Created on Tue Apr 23 16:21:08 2024
...
plt.savefig('acc_small_model.pdf')
...
plt.xlabel('epoch')
plt.legend(['train', 'val'], loc='upper left')
plt.savefig('loss_small_model.pdf')
...
encoder.save("model-encoder-trainingset-small_model.keras")
